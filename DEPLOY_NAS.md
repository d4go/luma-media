...
mkdir -p /vol3/1000/docker/luma-backup
cp -a /vol3/1000/docker/luma/luma.db* \
  /vol3/1000/docker/luma-backup/
```
...
LUMA_DATA_ROOT=/vol3/1000/docker/luma
```
...
/vol3/1000/docker/luma            -> /data
```

Luma 页面中的媒体目录填写容器路径 `/media`，不能填写宿主机路径 `/vol1/1000/a1`。
